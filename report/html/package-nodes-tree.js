...
{
    "id": "com.patient.api.dao.test",
    "text": "com.patient.api.dao.test",
    "package": "com.patient.api.dao.test",
    "url": "com/patient/api/dao/test/testsrc-pkg-summary.html",
            "coverage": "70.7%",
        "icon": "aui-icon aui-icon-small aui-iconfont-devtools-folder-closed",
            "li_attr": {"data-is-link": "true"},
        "a_attr": {"href": "com/patient/api/dao/test/testsrc-pkg-summary.html"},
    "children": [
                    ]
},
            ],
